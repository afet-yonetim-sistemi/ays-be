...
/**
 * {@link EmergencyEvacuationApplicationEntityToDomainMapper} is an interface that defines the
 ...
 */
@Mapper
public interface EmergencyEvacuationApplicationEntityToDomainMapper extends BaseMapper<EmergencyEvacuationApplicationEntity, EmergencyEvacuationApplication> {
     ...
     */
    static EmergencyEvacuationApplicationEntityToDomainMapper initialize() {
        return Mappers.getMapper(EmergencyEvacuationApplicationEntityToDomainMapper.class);
    }
