...
/**
 * AdminUserRegisterApplicationEntityToAdminUserRegisterApplication is an interface that defines the mapping between an {@link AdminRegisterApplicationEntity} and an {@link AdminRegistrationApplication}.
 ...
 */
@Mapper
public interface AdminRegisterApplicationEntityToAdminRegisterApplicationMapper extends BaseMapper<AdminRegisterApplicationEntity, AdminRegistrationApplication> {
    ...
    AdminRegistrationApplication map(AdminRegisterApplicationEntity entity);
