...
/**
 * Annotation to validate cities using {@link CityFilterValidator}.
 */
@Target(value = ElementType.FIELD)
@Retention(RetentionPolicy.RUNTIME)
@Constraint(validatedBy = CityFilterValidator.class)
public @interface CityFilter {

    /**
     * Returns the error message when city filter is not valid.
     *
