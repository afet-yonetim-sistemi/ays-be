...
/**
 * Annotation to validate names using {@link RoleNameFilterValidator}.
 */
@Target(value = ElementType.FIELD)
@Retention(RetentionPolicy.RUNTIME)
@Constraint(validatedBy = RoleNameFilterValidator.class)
public @interface RoleNameFilter {

    /**
     * Returns the error message when filter is not valid.
     *
