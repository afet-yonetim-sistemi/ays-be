...
class AysAuthControllerTest extends AysRestControllerTest {
        ...
        void givenValidLoginRequestWithValidEmailAddress_whenTokensGeneratedSuccessfully_thenReturnTokenResponse(
        ...
        void givenInvalidLoginRequestWithInvalidPassword_whenPasswordDoesNotValid_thenReturnValidationError(
        ...
        void givenInvalidLoginRequestWithInvalidEmailAddress_whenEmailsAreNotValid_thenReturnValidationError(
                        String mockEmailAddress) throws Exception {
                // Given
                AysLoginRequest mockLoginRequest = new AysLoginRequestBuilder()
                                .withEmailAddress(mockEmailAddress)
        ...
        void givenValidLoginRequestWithValidEmailAddress_whenEmailsAreValid_thenReturnSuccessResponse(
                        String mockEmailAddress) throws Exception {
                // Given
                AysLoginRequest mockLoginRequest = new AysLoginRequestBuilder()
                                .withEmailAddress(mockEmailAddress)
        ...
        void givenForgotPasswordRequestWithInvalidEmailAddress_whenEmailDoesNotValid_thenReturnValidationError(
                        String mockEmailAddress) throws Exception {
        ...
        @Test
        void givenForgotPasswordRequestWithoutEmailAddress_whenEmailIsNull_thenReturnValidationError()
                        throws Exception {
        ...
        void givenPasswordCreateRequest_whenPasswordDoesNotValid_thenReturnValidationError(String mockPassword)
                        throws Exception {
