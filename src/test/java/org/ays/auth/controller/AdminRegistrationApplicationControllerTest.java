...
class AdminRegistrationApplicationControllerTest extends AysRestControllerTest {
        ...
        private final AdminRegistrationApplicationToApplicationsResponseMapper adminRegistrationApplicationToApplicationsResponseMapper = AdminRegistrationApplicationToApplicationsResponseMapper
                        .initialize();
        private final AdminRegistrationApplicationToApplicationResponseMapper adminRegistrationApplicationToApplicationResponseMapper = AdminRegistrationApplicationToApplicationResponseMapper
                        .initialize();
        private final AdminRegistrationApplicationToSummaryResponseMapper adminRegistrationApplicationToSummaryResponseMapper = AdminRegistrationApplicationToSummaryResponseMapper
                        .initialize();
        private final AdminRegistrationApplicationToCreateResponseMapper adminRegistrationApplicationToCreateResponseMapper = AdminRegistrationApplicationToCreateResponseMapper
                        .initialize();

        private static final String BASE_PATH = "/api/v1";

        @Test
        void givenValidAdminRegisterApplicationListRequest_whenAdminRegisterApplicationsFound_thenReturnAysPageResponseOfAdminRegisterApplicationsResponse()
                        throws Exception {
                ...
                Mockito.when(adminRegistrationApplicationService
                ...
                List<AdminRegistrationApplicationSummaryResponse> mockApplicationsResponse = adminRegistrationApplicationToSummaryResponseMapper
                                .map(mockApplications);
                AysPageResponse<AdminRegistrationApplicationSummaryResponse> pageOfResponse = AysPageResponse
                                .<AdminRegistrationApplicationSummaryResponse>builder()
                                .of(mockApplicationPage)
                                .content(mockApplicationsResponse)
                                .build();
                AysResponse<AysPageResponse<AdminRegistrationApplicationSummaryResponse>> mockResponse = AysResponse
        ...
        @Test
        void givenValidAdminRegisterApplicationListRequest_whenUnauthorizedForListing_thenReturnAccessDeniedException()
                        throws Exception {
                // Given
                AdminRegistrationApplicationListRequest mockListRequest = new AdminRegistrationApplicationListRequestBuilder()
                                .withValidValues()
        ...
        @Test
        void givenValidAdminRegisterApplicationId_whenAdminRegisterApplicationFound_thenReturnAdminRegisterApplicationResponse()
                        throws Exception {
        ...
        @Test
        void givenValidAdminRegisterApplicationId_whenUnauthorizedForGettingAdminRegisterApplicationById_thenReturnAccessDeniedException()
                        throws Exception {
        ...
        void givenValidAdminRegisterApplicationCreateRequest_whenCreatingAdminRegisterApplication_thenReturnAdminRegisterApplicationCreateResponse(
                ...
                AysResponse<AdminRegistrationApplicationCreateResponse> mockResponse = AysResponse
                                .successOf(mockApplicationCreateResponse);
        ...
        void givenInvalidAdminRegisterApplicationCreateRequest_whenCreatingAdminRegisterApplication_thenReturnValidationError(
                        String invalidReason) throws Exception {
        ...
        @Test
        void givenValidAdminRegisterApplicationCreateRequest_whenUnauthorizedForCreatingAdminRegisterApplication_thenReturnAccessDeniedException()
                        throws Exception {
        ...
        @Test
        void givenValidAdminRegisterApplicationId_whenAdminApplicationFound_thenReturnAdminApplicationSummaryResponse()
                        throws Exception {
                ...
                String endpoint = BASE_PATH
                                .concat("/admin-registration-application/".concat(mockId).concat("/summary"));
                MockHttpServletRequestBuilder mockHttpServletRequestBuilder = AysMockMvcRequestBuilders
                                .get(endpoint);
        ...
        void givenValidAdminRegisterRequest_whenAdminRegistered_thenReturnSuccessResponse() throws Exception {
                ...
                // Then
                String endpoint = BASE_PATH.concat("/admin-registration-application/").concat(mockId)
                                .concat("/complete");
                MockHttpServletRequestBuilder mockHttpServletRequestBuilder = AysMockMvcRequestBuilders
        ...
        @Test
        void givenIdAndAdminRegisterRequest_whenAdminApplicationNotFound_thenReturnUnauthorizedError()
                        throws Exception {
        ...
        @Test
        void givenPhoneNumberWithAlphanumericCharacter_whenPhoneNumberIsNotValid_thenReturnValidationError()
                        throws Exception {
        ...
        @Test
        void givenPhoneNumberWithInvalidOperator_whenPhoneNumberIsNotValid_thenReturnValidationError()
                        throws Exception {
        ...
        @ValueSource(strings = {
                        ...
                        " user@example.com ",
                        "@missingusername.com",
                        "a@b.c", // 5 karakter - minimum limit altında
                        "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa@domain.com" // 255
                                                                                                                                                                                                                                                                                                     // karakter
                                                                                                                                                                                                                                                                                                     // -
                                                                                                                                                                                                                                                                                                     // maksimum
                                                                                                                                                                                                                                                                                                     // limit
        ...
        void givenInvalidAdminRegisterApplicationCompleteRequestWithParametrizedInvalidEmails_whenEmailsAreNotValid_thenReturnValidationError(
                        String invalidEmail) throws Exception {
        ...
        @ParameterizedTest
        @ValueSource(strings = {
                        "user@example.com", // 14 karakter - geçerli
                        "abcdef@mail.com", // 14 karakter - geçerli
                        "a.b.c.d@test.com", // 15 karakter - geçerli
                        "test.123@afetyonetimsistemi.org" // 29 karakter - geçerli
        })
        void givenValidAdminRegisterApplicationCompleteRequestWithParametrizedValidEmails_whenEmailsAreValid_thenReturnSuccessResponse(
                        String validEmail) throws Exception {
                // Given
        ...
        void givenInvalidAdminRegisterApplicationCompleteRequestWithInvalidPassword_whenPasswordDoesNotValid_thenReturnValidationError(
                        String mockPassword) throws Exception {
        ...
        @Test
        void givenValidAdminRegisterApplicationId_whenApproveAdminRegisterApplication_thenReturnNothing()
                        throws Exception {
                // Given
                ...
                // Then
                String endpoint = BASE_PATH
                                .concat("/admin-registration-application/".concat(mockId).concat("/approve"));
                MockHttpServletRequestBuilder mockHttpServletRequestBuilder = AysMockMvcRequestBuilders
        ...
        @Test
        void givenValidAdminRegisterApplicationId_whenUnauthorizedForApprovingAdminRegisterApplication_thenReturnAccessDeniedException()
                        throws Exception {
        ...
        @Test
        void givenValidAdminRegisterApplicationRejectRequest_whenRejectingAdminRegisterApplication_thenReturnSuccess()
                        throws Exception {
        ...
        void givenInvalidAdminRegisterApplicationRejectRequest_whenRejectingAdminRegisterApplication_thenReturnValidationError(
