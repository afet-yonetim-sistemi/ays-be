...
class AysUserControllerTest extends AysRestControllerTest {
        ...
        private final AysUserToUsersResponseMapper userToUsersResponseMapper = AysUserToUsersResponseMapper
                        .initialize();
        ...
        void givenUserListRequest_whenFirstNameDoesNotValid_thenReturnValidationError(String invalidName)
                        throws Exception {
        ...
        void givenUserListRequest_whenLastNameDoesNotValid_thenReturnValidationError(String invalidName)
                        throws Exception {
        ...
        void givenInvalidUserListRequest_whenPageSizeNotTen_thenReturnValidationError(int invalidPageSize)
                        throws Exception {
        ...
        void givenUserCreateRequest_whenRoleIdIsNotValid_thenReturnValidationError(String invalidRoleId)
                        throws Exception {
        ...
        void givenUserCreateRequest_whenEmailNotValid_thenReturnValidationError(String mockEmailAddress)
                        throws Exception {
                // Given
                AysUserCreateRequest mockCreateRequest = new AysUserCreateRequestBuilder()
                                .withValidValues()
        ...
        void givenUserCreateRequest_whenEmailValid_thenReturnSuccessResponse(String mockEmailAddress) throws Exception {
                // Given
                AysUserCreateRequest mockCreateRequest = new AysUserCreateRequestBuilder()
                                .withValidValues()
                                .withEmailAddress(mockEmailAddress)
        ...
        void givenInvalidIdAndValidUserUpdateRequest_whenIdNotValid_thenReturnValidationError(String invalidId)
                        throws Exception {
        ...
        void givenValidIdAndInvalidUserUpdateRequest_whenRoleIdIsNotValid_thenReturnValidationError(
                        String invalidRoleId) throws Exception {
        ...
        void givenValidIdAndInvalidUserUpdateRequest_whenEmailNotValid_thenReturnValidationError(
                        String mockEmailAddress) throws Exception {
                // Given
        ...
        void givenInvalidUserId_whenIdNotValid_thenReturnValidationErrorForPassivate(String invalidId)
                        throws Exception {
