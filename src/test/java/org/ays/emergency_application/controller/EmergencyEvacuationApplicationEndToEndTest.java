...
class EmergencyEvacuationApplicationEndToEndTest extends AysEndToEndTest {
        ...
        private final EmergencyEvacuationApplicationToApplicationResponseMapper emergencyEvacuationApplicationToApplicationResponseMapper = EmergencyEvacuationApplicationToApplicationResponseMapper
                        .initialize();

        private static final String BASE_PATH = "/api/v1";

        @Test
        void givenValidEmergencyEvacuationApplicationListRequest_whenApplicationsFound_thenReturnAysPageResponseOfEmergencyEvacuationApplicationsResponse()
                        throws Exception {
                ...
                AysResponse<AysPageResponse<EmergencyEvacuationApplication>> mockResponse = AysResponseBuilder
                                .successPage();
        ...
        @Test
        void givenValidEmergencyEvacuationApplicationRequest_whenApplicationSaved_thenReturnSuccessResponse()
                        throws Exception {
                // Given
                ...
                Optional<EmergencyEvacuationApplication> application = emergencyEvacuationApplicationReadPort
                                ...
                                .getContent().stream()
                                .filter(evacuationApplication -> evacuationApplication.getFirstName()
                                                .equals(applicationRequest.getFirstName()))
                                .findFirst();
                ...
                Assertions.assertEquals(application.get().getPhoneNumber().getCountryCode(),
                                applicationRequest.getPhoneNumber().getCountryCode());
                Assertions.assertEquals(application.get().getPhoneNumber().getLineNumber(),
                                applicationRequest.getPhoneNumber().getLineNumber());
                ...
                Assertions.assertEquals(application.get().getApplicantFirstName(),
                                applicationRequest.getApplicantFirstName());
                Assertions.assertEquals(application.get().getApplicantLastName(),
                                applicationRequest.getApplicantLastName());
                Assertions.assertEquals(application.get().getApplicantPhoneNumber().getCountryCode(),
                                applicationRequest.getApplicantPhoneNumber().getCountryCode());
                Assertions.assertEquals(application.get().getApplicantPhoneNumber().getLineNumber(),
                                applicationRequest.getApplicantPhoneNumber().getLineNumber());
        ...
        @Test
        void givenValidEmergencyEvacuationApplicationRequestWithoutApplicant_whenApplicationSaved_thenReturnSuccessResponse()
                        throws Exception {
                // Given
