...
@Deprecated(since = "1.2.0 - Use or Develop EmergencyEvacuationApplicationControllerTest Class", forRemoval = true)
class EmergencyEvacuationApplicationControllerOldTest extends AysRestControllerTest {
