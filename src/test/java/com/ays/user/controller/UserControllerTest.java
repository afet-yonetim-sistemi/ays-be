...
//                .andExpect(jsonPath("$.content[0].role", is(UserRole.VOLUNTEER.name())))
...
//                .andExpect(jsonPath("$.content[1].role", is(UserRole.VOLUNTEER.name())));
//    }
//
//    @Test
...
//
//        // when
//        when(userService.updateUser(userUpdateRequest)).thenReturn(updatedDTO);
//
...
//                .andExpect(MockMvcResultMatchers.jsonPath("$.status", Matchers.is(updatedDTO.getStatus().name())));
//
//    }
//
//}
