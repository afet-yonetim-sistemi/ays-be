...
ssh -o StrictHostKeyChecking=no -i private_key ${AWS_USERNAME}@${AWS_TEST_ENVIRONMENT_IP} ; sudo su ; cd ${AWS_BE_APP_PATH} ; git status ; git switch main ; git fetch --all ; git pull origin main || exit
